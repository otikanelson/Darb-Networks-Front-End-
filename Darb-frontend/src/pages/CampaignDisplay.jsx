...
import DisplayNavbar from '../components/Navbars/DisplayNavbar';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
              ...
              <h4 className="font-bold text-gray-900 py-2 text-lg mb-3">Project Timeline</h4>
              ...
              <h4 className="font-bold text-gray-900 text-lg py-2 mb-1">Minimum Investment</h4>
            ...
            <div className="space-y-4">
              <button 
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-2 rounded-xl 
