...
import { Plus, Trash2, ChevronRight, ChevronLeft, Linkedin, Mail, Twitter } from 'lucide-react';

const TeamStep = ({ formData, setFormData, onNext, onPrev }) => {
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg space-y-6">
        ...
        <div className="space-y-6">
          {formData.team?.map((member) => (
            <div key={member.id} className="border border-gray-200 rounded-lg p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`mt-1 block w-full rounded-md border
                        ...
                        focus:border-green-500 focus:ring focus:ring-green-200 focus:ring
